...
public class HigherOrderMutationTestMinion {
  ...
  public HigherOrderMutationTestMinion(final SafeDataInputStream dis,
  ...
  public static void main(final String[] args) {
    ...
    try {
      ...
      final HigherOrderMutationTestMinion instance = new HigherOrderMutationTestMinion(dis, reporter);
      instance.run();
    } catch (final Throwable ex) {
      ex.printStackTrace(System.out);
      LOG.log(Level.WARNING, "Error during mutation test", ex);
